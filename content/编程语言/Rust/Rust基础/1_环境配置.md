...
1. [cargo-generate](https://github.com/cargo-generate/cargo-generate)：项目模板生成工具

   ```sh
   cargo install cargo-generate
   ```

2. [cargo-deny](https://github.com/EmbarkStudios/cargo-deny)：检查项目依赖

   ```sh
   cargo install --locked cargo-deny
   ```

3. [git-cliff](https://github.com/orhun/git-cliff)：生成 changelog
