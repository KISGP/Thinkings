...
- 单词种别
  ...
  **通常用整数编码表示，表示单词的种类**，它是语法分析所需要的信息。
  ...
  ![](assets/CompilationPrinciple22.png)
...
![](assets/CompilationPrinciple24.png)

![](assets/CompilationPrinciple23.png)
...
![](assets/CompilationPrinciple27.png)

![](assets/CompilationPrinciple28.png)
...
![](assets/CompilationPrinciple29.png)
...
![](assets/CompilationPrinciple30.png)
...
![](assets/CompilationPrinciple33.png)

将上述状态转换图转换成状态转换矩阵，如下图表示

![](assets/CompilationPrinciple34.png)
...
![](assets/CompilationPrinciple31.png)
...
![](assets/CompilationPrinciple36.png)

![](assets/CompilationPrinciple37.png)
...
![](assets/CompilationPrinciple44.png)

![](assets/CompilationPrinciple45.png)
...
- ![](assets/CompilationPrinciple46.png)
- ![](assets/CompilationPrinciple47.png)
- ![](assets/CompilationPrinciple48.png)

![](assets/CompilationPrinciple49.png)
...
2. 设 $a$ 是 $\Sigma$ 中的一个字符，定义 $I_a=\varepsilon -closure(J)$。其中， $J$ 为 $I$ 中的某个状态出发经过一条 $a$ 弧而到达的状态集合。
   ...
   ![](assets/CompilationPrinciple38.png)

3. 例如：

   ![](assets/CompilationPrinciple39.png)
...
![](assets/CompilationPrinciple40.png)

构造的转换表如下图所示

![](assets/CompilationPrinciple41.png)

下图中划红线的是初态，蓝线的是终态

![](assets/CompilationPrinciple42.png)

把转换表变成相应的状态转换矩阵和DFA M'

![](assets/CompilationPrinciple43.png)
...
2. 对当前划分出的$I^{(1)},I^{(2)},\cdots,I^{(m)}$子集进行划分。划分依据：对某个 $I^{(i)}=\{s_1 ,s_2 ,\cdots ,s_k \}$，若存在一个输入字符 $a$ 使得 $I_a^{(i)}$ **不全包含**在当前划分的某个子集 $I^{(i)}$ 中，则至少应把 $I^{(i)}$ 分为两个部分。
   ...
   - 划分依据：
     ...
     ![](assets/CompilationPrinciple62.png)
     ...
     ![](assets/CompilationPrinciple63.png)
...
![](assets/CompilationPrinciple64.png)

![](assets/CompilationPrinciple65.png)

![](assets/CompilationPrinciple66.png)
...
2. 然后，反复使用下面的规则，逐步消去的所有结点，直到只剩下 X 和 Y 为止；
   ...
   ![](assets/CompilationPrinciple50.png)

   例如：

   ![](assets/CompilationPrinciple51.png)
...
1. 若 r 具有零个运算符，则 $r= \varepsilon$ 或 $r=\Phi$ 或 $r=a$，其中 $a\in \Sigma$。
   ...
   ![](assets/CompilationPrinciple52.png)
...
2. 若 r 中含有 $k(k\geqslant 1)$ 个运算符时， r 有三种情形 ：
   ...
   - 情形1：$r=r_1 |r_2$， $r_1$ 和 $r_2$ 中运算符个数少于 k 。
     ...
     ![](assets/CompilationPrinciple53.png)

     ![](assets/CompilationPrinciple54.png)

   - 情形2：$r=r_1 r_2$。

     ![](assets/CompilationPrinciple55.png)

     ![](assets/CompilationPrinciple56.png)

   - 情形3： $r=r_1 ^*$ 。
   
     ![](assets/CompilationPrinciple57.png)
   
     ![](assets/CompilationPrinciple58.png)
...
1. 构造 $\Sigma$ 上的 NFA M' 使得 L(V)=L(M')
   ...
   ![](assets/CompilationPrinciple59.png)

2. 按下面的三条规则对 V 进行分裂

   ![](assets/CompilationPrinciple60.png)

3. 逐步把这个图转变为每条弧只标记为 $\Sigma$ 上的 一个字符或 $\varepsilon$，最后得到一个 NFA M' ， 显然 L(M')=L(V)

以下是将正规式转换成有限自动机的示例：

![](assets/CompilationPrinciple61.png)
...
![](assets/CompilationPrinciple67.png)
...
![](assets/CompilationPrinciple68.png)
