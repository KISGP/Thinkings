...
5. 语言简洁，易学易用
   ...
   ![](assets/Database34.png)

## 基本概念

SQL支持关系数据库三级模式结构。

![](assets/Database35.png)
...
![](assets/Database36.png)

![](assets/Database37.png)

![](assets/Database38.png)

# 数据定义

SQL的数据定义功能：模式定义、表定义、视图和索引的定义。

![](assets/Database39.png)
...
![](assets/Database40.png)

![](assets/Database41.png)
...
![](assets/Database46.png)

---

删除索引，格式：

![](assets/Database47.png)
...
- 消除取值重复的行
  ...
  ![](assets/Database51.png)

- 查询满足条件的元组

  ![](assets/Database52.png)

  1. 比较大小

     ![](assets/Database53.png)

  2. 确定范围

     ![](assets/Database54.png)

  3. 确定集合

     ![](assets/Database55.png)
...
![](assets/Database62.png)

![](assets/Database63.png)
...
![](assets/Database66.png)

一条SQL语句可以同时完成选择和连接查询，这时WHERE子句是由连接谓词和选择谓词组成的复合条件。

![](assets/Database67.png)
...
![](assets/Database72.png)

![](assets/Database73.png)
...
![](assets/Database77.png)

![](assets/Database78.png)
...
![](assets/Database87.png)

判断一个属性的值是否为空值，用IS NULL或IS NOT NULL来表示。

![](assets/Database88.png)
...
- 空值与另一个值（包括另一个空值）的比较运算的结果为UNKNOWN。有了UNKNOWN后，传统二值（TRUE，FALSE）逻辑就扩展成了三值逻辑。
  ...
  ![](assets/Database89.png)

![](assets/Database90.png)
...
- 基于多个基表的视图
  ...
  ![](assets/Database92.png)

- 基于视图的视图

  ![](assets/Database93.png)

- 带表达式的视图

  ![](assets/Database94.png)

- 分组视图

  ![](assets/Database95.png)
...
![](assets/Database96.png)

有些情况下，视图消解法不能生成正确的查询。

## 更新视图

![](assets/Database97.png)
